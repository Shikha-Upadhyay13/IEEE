...
export function EquationEditor({
  ...
  return (
    ...
    <math-field
      ref={ref}
      className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-3 py-2 text-base focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500"
    />
  );
}
